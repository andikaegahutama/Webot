...
import type {ClickOptions, ElementHandle} from 'puppeteer-core/src/api/ElementHandle.js';
...
import type {PuppeteerLifeCycleEvent} from 'puppeteer-core/src/cdp/LifecycleWatcher.js';
import {EventEmitter, type EventType} from 'puppeteer-core/src/common/EventEmitter.js';
import {getQueryHandlerAndSelector} from 'puppeteer-core/src/common/GetQueryHandler.js';
import {transposeIterableHandle} from 'puppeteer-core/src/common/HandleIterator.js';
import type {
  Awaitable,
  EvaluateFunc,
  EvaluateFuncWith,
...
import {throwIfDisposed} from 'puppeteer-core/src/util/decorators.js';

import type {CDPSession} from 'puppeteer-core/src/api/CDPSession.js';
import type {KeyboardTypeOptions} from 'puppeteer-core/src/api/Input.js';
import {
  FunctionLocator,
  NodeLocator,
  type Locator,
} from 'puppeteer-core/src/api/locators/locators.js';
import type {Realm} from 'puppeteer-core/src/api/Realm.js';
