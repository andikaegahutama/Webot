...
import type {Accessibility} from 'puppeteer-core/src/cdp/Accessibility.js';
import type {Coverage} from 'puppeteer-core/src/cdp/Coverage.js';
...
import type {Tracing} from 'puppeteer-core/src/cdp/Tracing.js';
import type {ConsoleMessage} from 'puppeteer-core/src/common/ConsoleMessage.js';
import type {
  Cookie,
  CookieParam,
  DeleteCookiesRequest,
} from 'puppeteer-core/src/common/Cookie.js';
import type {Device} from 'puppeteer-core/src/common/Device.js';
...
import {
  ...
  type EventType,
  type Handler,
} from 'puppeteer-core/src/common/EventEmitter.js';
import type {FileChooser} from 'puppeteer-core/src/common/FileChooser.js';
import type {PDFOptions} from 'puppeteer-core/src/common/PDFOptions.js';
import {TimeoutSettings} from 'puppeteer-core/src/common/TimeoutSettings.js';
import type {
  Awaitable,
  AwaitablePredicate,
  EvaluateFunc,
  ...
  HandleFor,
  NodeFor,
} from 'puppeteer-core/src/common/types.js';
import {
  debugError,
  fromEmitterEvent,
  filterAsync,
...
import type {ScreenRecorder} from 'puppeteer-core/src/node/ScreenRecorder.js';
import {guarded} from 'puppeteer-core/src/util/decorators.js';
import {
  AsyncDisposableStack,
  asyncDisposeSymbol,
  DisposableStack,
  disposeSymbol,
} from 'puppeteer-core/src/util/disposable.js';
...
import type {
  ...
  ClickOptions,
  ElementHandle,
} from 'puppeteer-core/src/api/ElementHandle.js';
import type {
  Frame,
...
import type {
  ...
  Mouse,
  Touchscreen,
} from 'puppeteer-core/src/api/Input.js';
...
import {
  ...
  NodeLocator,
  type AwaitedLocator,
} from 'puppeteer-core/src/api/locators/locators.js';
import type {Target} from 'puppeteer-core/src/api/Target.js';
...
export abstract class Page extends EventEmitter<PageEvents> {
  ...
  async screencast(
    ...
    const [{ScreenRecorder}, [width, height, devicePixelRatio]] =
      await Promise.all([
        import('puppeteer-core/src/node/ScreenRecorder.js'),
