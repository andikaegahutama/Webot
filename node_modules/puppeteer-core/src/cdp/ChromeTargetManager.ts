...
import type {TargetFilterCallback} from 'puppeteer-core/src/api/Browser.js';
import {CDPSession, CDPSessionEvent} from 'puppeteer-core/src/api/CDPSession.js';
...
import type {CdpCDPSession} from 'puppeteer-core/src/cdp/CDPSession.js';
import type {Connection} from 'puppeteer-core/src/cdp/Connection.js';
import {CdpTarget, InitializationStatus} from 'puppeteer-core/src/cdp/Target.js';
import {
  type TargetFactory,
  type TargetManager,
  TargetManagerEvent,
  type TargetManagerEvents,
} from 'puppeteer-core/src/cdp/TargetManager.js';
