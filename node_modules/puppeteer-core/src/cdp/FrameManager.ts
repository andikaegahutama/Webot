...
import {type CDPSession, CDPSessionEvent} from 'puppeteer-core/src/api/CDPSession.js';
import {FrameEvent} from 'puppeteer-core/src/api/Frame.js';
import type {NewDocumentScriptEvaluation} from 'puppeteer-core/src/api/Page.js';
...
import {debugError, PuppeteerURL, UTILITY_WORLD_NAME} from 'puppeteer-core/src/common/util.js';
import {assert} from 'puppeteer-core/src/util/assert.js';
import {Deferred} from 'puppeteer-core/src/util/Deferred.js';
import {disposeSymbol} from 'puppeteer-core/src/util/disposable.js';
import {isErrorLike} from 'puppeteer-core/src/util/ErrorLike.js';

import type {Binding} from 'puppeteer-core/src/cdp/Binding.js';
import {CdpPreloadScript} from 'puppeteer-core/src/cdp/CdpPreloadScript.js';
...
import {DeviceRequestPromptManager} from 'puppeteer-core/src/cdp/DeviceRequestPrompt.js';
import {ExecutionContext} from 'puppeteer-core/src/cdp/ExecutionContext.js';
import {CdpFrame} from 'puppeteer-core/src/cdp/Frame.js';
import type {FrameManagerEvents} from 'puppeteer-core/src/cdp/FrameManagerEvents.js';
import {FrameManagerEvent} from 'puppeteer-core/src/cdp/FrameManagerEvents.js';
import {FrameTree} from 'puppeteer-core/src/cdp/FrameTree.js';
import type {IsolatedWorld} from 'puppeteer-core/src/cdp/IsolatedWorld.js';
import {MAIN_WORLD, PUPPETEER_WORLD} from 'puppeteer-core/src/cdp/IsolatedWorlds.js';
import {NetworkManager} from 'puppeteer-core/src/cdp/NetworkManager.js';
import type {CdpPage} from 'puppeteer-core/src/cdp/Page.js';
