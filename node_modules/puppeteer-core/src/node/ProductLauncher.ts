...
import type {Browser, BrowserCloseCallback} from 'puppeteer-core/src/api/Browser.js';
import {CdpBrowser} from 'puppeteer-core/src/cdp/Browser.js';
import {Connection} from 'puppeteer-core/src/cdp/Connection.js';
import {TimeoutError} from 'puppeteer-core/src/common/Errors.js';
import type {Product} from 'puppeteer-core/src/common/Product.js';
import {debugError, DEFAULT_VIEWPORT} from 'puppeteer-core/src/common/util.js';
...
} from 'puppeteer-core/src/node/LaunchOptions.js';
import {NodeWebSocketTransport as WebSocketTransport} from 'puppeteer-core/src/node/NodeWebSocketTransport.js';
import {PipeTransport} from 'puppeteer-core/src/node/PipeTransport.js';
import type {PuppeteerNode} from 'puppeteer-core/src/node/PuppeteerNode.js';
...
export abstract class ProductLauncher {
  ...
  protected async createBiDiOverCdpBrowser(
    ...
    const BiDi = await import(/* webpackIgnore: true */ 'puppeteer-core/src/bidi/bidi.js');
